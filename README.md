...
Este repositório contém minhas anotações pessoais relacionadas às disciplinas que ministro.
...
- [Programação e Desenvolvimento de Banco de Dados](pbd)
...
- [Fundamentos de Instalações Elétricas de Baixa Tensão](iebt)
...
Este repositório foi desenvolvido com o suporte de ferramentas de inteligência artificial (IA) para otimizar processos, oferecer sugestões e aprimorar a eficiência do trabalho. No entanto, todas as informações passaram por revisão criteriosa, testes e validação, garantindo precisão e confiabilidade. A IA foi utilizada como um recurso complementar para acelerar o desenvolvimento, sem substituir a análise crítica, a tomada de decisão e a autoria humana.
